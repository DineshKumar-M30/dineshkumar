        ...
        <div className="w-[240px] bg-white h-screen border-r border-gray-100 flex flex-col transition-all duration-300">
                ...
                <div className="space-y-1">
                    {menuItems.map((item, index) => (
                        <button
                            ...
                            className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-all duration-300 hover-scale ${activeItem === item.label
            ...
            <div className="p-4 border-t border-gray-50 space-y-1">
                <button
                    ...
                    className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-colors ${activeItem === 'Settings'
                        ? 'bg-blue-600 text-white shadow-lg shadow-blue-200'
                        : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'
                        }`}
                >
                    <Settings size={20} className={activeItem === 'Settings' ? 'text-white' : 'text-gray-500'} />
                    <span>Settings</span>
                </button>
                <button className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium text-gray-600 hover:bg-red-50 hover:text-red-600 transition-colors group">
