...
const Products = ({ products, toggleFavorite }) => {
    return (
        <div className="p-6">
            ...
            <div className="w-full bg-blue-500 rounded-[20px] p-8 md:p-12 mb-8 relative overflow-hidden flex flex-col justify-center min-h-[250px] md:min-h-[300px]">
                ...
                <div className="relative z-10 max-w-xl">
                    <span className="text-blue-100 text-[10px] md:text-sm font-medium mb-2 block">September 12-22</span>
                    <h1 className="text-2xl md:text-4xl font-bold text-white mb-4 leading-tight">
                        Enjoy free home<br className="hidden md:block" /> delivery in this summer
                    </h1>
                    <p className="text-blue-100 mb-6 md:mb-8 text-sm md:text-lg">Designer Dresses - Pick from trendy Designer Dress.</p>

                    <button className="px-6 md:px-8 py-2.5 md:py-3 bg-orange-500 hover:bg-orange-600 text-white text-sm md:text-base font-semibold rounded-xl transition-colors shadow-lg shadow-orange-500/30">
                        Get Started
                    </button>
                </div>
