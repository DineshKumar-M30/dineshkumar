    ...
    const stats = [
        {
            ...
            value: '40,689',
            icon: Users,
            iconBgColor: 'bg-indigo-100', // Light Purple
        ...
        },
        {
            ...
            value: '10293',
            icon: Box,
            iconBgColor: 'bg-yellow-100', // Light Yellow
        ...
        },
        {
            title: 'Total Sales',
            value: '$89,000',
            icon: BarChart, // Closest match for graph
            iconBgColor: 'bg-green-100', // Light Green
        ...
        },
        {
            title: 'Total Pending',
            value: '2040',
            icon: History, // Clock/History icon
            iconBgColor: 'bg-orange-100', // Light Orange
